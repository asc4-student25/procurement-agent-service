...
| Field | Value |
|-------|-------|
| Last stable commit hash | 778605f |
...
| Role | Name | Contact |
|------|------|---------|
| Release Manager / Decision Maker | Krishnaraj Muthuvel | [pending] |
| Technical Lead | Dina Pilongo | [pending] |
| Instructor / Supervisor | Stephen Ray Dividina | [pending] |
